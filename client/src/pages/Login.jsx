...
import shotlogo from "../assets/logo2.png"; // Kept import to prevent errors, though using text logo per design
    ...
    return (
        <div className="min-h-screen bg-[#0A0014] text-slate-100 flex flex-col items-center py-6 px-4 font-sans relative overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden flex justify-center items-center">
                <div className="absolute top-[20%] w-[500px] h-[500px] bg-[#FF2994] rounded-full mix-blend-screen filter blur-[120px] opacity-10"></div>
                <div className="absolute bottom-0 w-[400px] h-[400px] bg-[#8B2BFF] rounded-full mix-blend-screen filter blur-[150px] opacity-15"></div>
            </div>
                ...
                <div className="w-full bg-[#150A2A]/90 backdrop-blur-xl border border-white/5 rounded-[32px] p-6 shadow-2xl">
                    ...
                    {!genderSelected ? (
                        ...
                        <div className="animate-fadeIn text-center py-4">
                            <h2 className="text-2xl font-bold mb-2">Select Gender</h2>
                            <p className="text-slate-400 text-sm mb-8">Choose your gender to continue</p>
                            
                            <div className="flex justify-center gap-6">
                                <button
                                    type="button"
                                    onClick={() => handleGenderSelect('male')}
                                    className="flex flex-col items-center gap-3 p-5 bg-[#1C1035] border border-white/10 rounded-2xl hover:border-[#8B2BFF] hover:bg-[#251545] transition-all duration-300 w-32 cursor-pointer shadow-lg"
                                >
                                    <img 
                                        src="https://ik.imagekit.io/ufopzzlbh/p.jpeg" 
                                        alt="Boy Avatar" 
                                        className="w-16 h-16 rounded-full object-cover border-2 border-[#8B2BFF]/50"
                                    />
                                ...
                                <button
                                    ...
                                    className="flex flex-col items-center gap-3 p-5 bg-[#1C1035] border border-white/10 rounded-2xl hover:border-[#FF2994] hover:bg-[#251545] transition-all duration-300 w-32 cursor-pointer shadow-lg"
                                >
                                    <img 
                                        src="https://ik.imagekit.io/ufopzzlbh/58964_BYSKi0X54.png" 
                                        alt="Girl Avatar" 
                                        className="w-16 h-16 rounded-full object-cover border-2 border-[#FF2994]/50"
                                    />
                        ...
                        <div className="animate-fadeIn">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-slate-400 text-sm">Where conversations turn into connections</p>
                            </div>
